...
<main>
    <div class="tituloPaginaEntidade col-md-5 col-sm-6">
        <h1 class="h3">Insira os Dados do Funcionário:</h1>
    </div>
    <form class="container-fluid" action="index.php" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-6">
                <input type="text" class="form-control" id="campoNomeFuncionario" name="nome">
            </div>
        </div>
        <div class="form-group row">
            <label for="campoCpfFuncionario" class="col-md-1 col-form-label">CPF</label>
            <div class="col-md-4 col-sm-6">
                <input type="text" class="form-control" id="campoCpfFuncionario" name="cpf">
            </div>
        </div>
        <div class="form-group row">
